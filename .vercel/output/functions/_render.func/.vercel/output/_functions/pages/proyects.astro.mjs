/* empty css                                 */
import { c as createComponent, d as createAstro, m as maybeRenderHead, s as spreadAttributes, a as renderTemplate, b as addAttribute, f as renderSlot, r as renderComponent } from '../chunks/astro/server_DYiyW8_1.mjs';
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/Layout_ChqX8gCM.mjs';
import 'clsx';
...
}, "/root/Portfolio/src/components/icons/NextJs.astro", void 0);
...
}, "/root/Portfolio/src/components/icons/Tailwind.astro", void 0);
...
}, "/root/Portfolio/src/components/icons/Solidity.astro", void 0);

const $$Foundry = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<img src="images/Foundry.png" width="10" height="10" decoding="async" loading="lazy" alt="Foundry" class="">`;
}, "/root/Portfolio/src/components/icons/Foundry.astro", void 0);
...
}, "/root/Portfolio/src/components/LinkButton.astro", void 0);
...
}, "/root/Portfolio/src/components/icons/Github.astro", void 0);
...
}, "/root/Portfolio/src/components/icons/Link.astro", void 0);
  ...
  const PROJECTS = [
    {
      ...
      link: "https://quadraticcrowdfunding.vercel.app/",
    ...
    {
      title: "MerkleAirdrop",
      description: "Token airdrop using Merkles and signature verification",
      image: "images/Airdrop.svg",
...
}, "/root/Portfolio/src/pages/proyects.astro", void 0);

const $$file = "/root/Portfolio/src/pages/proyects.astro";
const $$url = "/proyects";
